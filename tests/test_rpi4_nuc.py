...
class rpi4Class:
    def __init__(self):
        f = open(os.path.abspath("config_rpi4.yaml"), "r")
    ...
    def run_network_ssh(self, tflite_model = "model.tflite", model_path="./tmp/", save_dir = "./tmp", niter = 10, print_bool = False, sleep_time=0,
        ...
        if not c.is_connected:
            ...
            c.put("/home/tgrill/SoC_EML_ANNETTE/src/annette/hw_modules/tests/test_rpi4_nuc.py", "tgrill/test_annette_ssh")
            c.put("/home/tgrill/SoC_EML_ANNETTE/src/annette/hw_modules/tests/config_rpi4.yaml", "tgrill/test_annette_ssh")
            c.put(model_path + tflite_model, "tgrill/test_annette_ssh")
            
            exec_command = "source /home/ubuntu/tgrill/test_annette_ssh/.venv_annette/bin/activate && " + "cd tgrill/test_annette_ssh && " + "python3 test_rpi4_nuc.py --no-ssh --model_path /home/ubuntu/tgrill/test_annette_ssh/ --tflite_model " + tflite_model + " --niter " + str(niter) + " --sleep " + str(sleep_time) + ""
    ...
    def run_network(self, tflite_path = "./tmp/model.tflite", save_dir = "./tmp", niter = 10, print_bool = False, sleep_time=0,
        ...
        #tflite_path = "/home/tgrill/models/mobilenet_v1_1.0_224.tflite"
...
def main():
    ...
    tflite_path = args.model_path + args.tflite_model
