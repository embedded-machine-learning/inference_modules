...
def test_optimize_network(network="/home/ubuntu/imatvey/inference_modules/tests/networks/mobilenetv2-7-sim0.tflite"):
    test_net = network
...
def test_run_network(network="/home/ubuntu/imatvey/inference_modules/tests/networks/mobilenetv2-7-sim0.tflite"):
    test_net = network
...
def main():
    ...
    test_all(network='/home/ubuntu/imatvey/inference_modules/tests/networks/mobilenetv2-7-sim0.tflite')
